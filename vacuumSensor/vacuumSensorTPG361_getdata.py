...
#DEVLOCATION = '/dev/serial/by-id/usb-FTDI_FT232R_USB_UART_AC01O8QI-if00-port0'; # angleMeter
#DEVLOCATION = '/dev/serial/by-id/usb-FTDI_USB-RS485_Cable_FT1TEPDB-if00-port0'; # tandem CC-10
...
if __name__ == '__main__':
  ...
  vs = VacuumSensor.VacuumSensorTPG361(devlocation, verbose=verbose);
