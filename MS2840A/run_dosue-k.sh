#!/bin/bash
# Usage: ./run_dosue-k.sh <PERSON> <FREQ>
# ex) ./run_dosue-k.sh adachi 10.1
...
if [ ! $# -eq 2 ] && [ ! $# -eq 3 ]; then
    ...
    echo "Usage: ./run_dosue-k.sh <PERSON> <FREQ>"
    echo "       ./run_dosue-k.sh <PERSON> <FREQ> [<ONE_STEP_ONLY>]"
    echo "ex) ./run_dosue-k.sh adachi 10.1"
...
RUN=true
#RUN=false
DIR=2023-12-18_smallBB
#DIR=test

source /home/dosue/venv/env1/bin/activate # for python3
LOG="/data/ms2840a/dosue-k/$DIR.log"
SEARCH="/data/ms2840a/dosue-k/signal_data/$DIR"
YFACTOR_300K_BEFORE="/data/ms2840a/dosue-k/yfactor_300K_ini/$DIR" # 300K before measurement
YFACTOR_77K_BEFORE="/data/ms2840a/dosue-k/yfactor_77K_ini/$DIR" # 77K before measurement
YFACTOR_300K_AFTER="/data/ms2840a/dosue-k/yfactor_300K_fin/$DIR" # 300K after measurement
YFACTOR_77K_AFTER="/data/ms2840a/dosue-k/yfactor_77K_fin/$DIR" # 77K after measurement
