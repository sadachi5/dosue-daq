...
#python3 ms2840a.py -m 'FFT' -s 20.0 -w 2.5e+3 -r 1 -t 2 -n 1 --nRun 1 -v 2 -f test_FFT --overwrite | tee test_FFT.out
...
#python3 ms2840a.py -m 'SWEEP' -s 18.0 -w 8.5e+6 -r 1.e+3 -n 1 --nRun 1 -v 2 -f test_SWEEP --overwrite | tee test_SWEEP.out
