...
#python3 ms2840a.py -m 'FFT' -s 20.0 -w 2.5e+3 -r 0.3 -t 1 -n 1 --nRun 12 -f test --noplot --overwrite
...
#python3 ms2840a.py -m 'SWEEP' -s 18.0 -w 8.5e+6 -r 1.e+3 -n 1 --nRun 1 -f SWEEP_plate1
