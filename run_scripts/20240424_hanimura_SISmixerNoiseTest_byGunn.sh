...
if [ $YN = "y" ]; then
    ...
    python3 ../MS2840A/MS2840A.py -f DOSUE-Y_test_SWEEP_NoiseTest_Gunn_LO$((LO+i-1))_300K -m 'SWEEP' -s $start -w $width -r $rbw -n ${nLoop} --att 0 --nRun ${nRun} --overwrite
...
if [ $YN2 = "y" ]; then
    ...
    python3 ../MS2840A/MS2840A.py -f DOSUE-Y_test_SWEEP_NoiseTest_Gunn_LO$((LO+i-1))_77K -m 'SWEEP' -s $start -w $width -r $rbw -n ${nLoop} --att 0 --nRun ${nRun} --overwrite
