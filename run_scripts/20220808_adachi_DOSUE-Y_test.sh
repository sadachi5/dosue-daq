...
# DOSUE-Y IF test at 300 K for Wifi
#python3 ../MS2840A/MS2840A.py -f DOSUE-Y_test300K_AllAmpNoWifi_SWEEP_many$1 -m 'SWEEP' -s 5e+9 -w 1e+9 -r 1e+6 -n 1 --att 0 --nRun 100 --overwrite
